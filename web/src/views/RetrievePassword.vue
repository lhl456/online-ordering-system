  ...
  <div class="main-context">
    <el-card class="box-card">
      <el-space direction="vertical" style="width: 100%" size="large">
        <el-space>
          <img src="../assets/logo.jpg" width="100%" style="width: 55px">
          <el-space direction="vertical" style="width: 100%" size="small">
            <h2 style="font-style: oblique">在线订餐系统</h2>
            <span style="font-style: oblique;font-size: 15px">Online Ordering</span>
          </el-space>
        </el-space>
